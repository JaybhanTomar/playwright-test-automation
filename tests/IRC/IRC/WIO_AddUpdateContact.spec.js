...
import WIO_SearchAndAddContact from '../../pages/AddupdatecontactPage';
import { WIOAddContactData, WIOSearchContactData } from '../../DataProvider/ContactData';
import BaseURL from '../../utils/BaseURL';
import LoginPage from '../../pages/LoginPage';
const loginTestData = require('../../DataProvider/UserCreationUpdationData').userLoginData();

test.describe.skip('WIO AddUpdateContact Tests', () => {
  ...
  test('Verify WIO Contact Add', async ({}, testInfo) => {
    const WIOContactAddData = WIOAddContactData();
  ...
  test('Verify WIO Contact Search', async ({}, testInfo) => {
    const WIOContactSearchData = WIOSearchContactData();
